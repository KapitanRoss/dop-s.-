...
my_dict[sorted_students[1]] = (sum(grades[1])/len(grades[1]))
my_dict[sorted_students[2]] = (sum(grades[2])/len(grades[2]))
my_dict[sorted_students[3]] = (sum(grades[3])/len(grades[3]))
my_dict[sorted_students[4]] = (sum(grades[4])/len(grades[4]))
print(my_dict)
